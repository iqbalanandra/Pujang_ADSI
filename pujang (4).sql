...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2024 at 08:19 PM
...
(2, 'iqbal', 'Muhammad Iqbal Anandra', 'iqbal@gmail.com', '321', '../image/profile/iqbal.jpg', 'user'),
...
INSERT INTO `user_buku` (`id_user_buku`, `ISBN`, `id`, `status`) VALUES
(1, '9780156012195', 2, 'Reading'),
(2, '9780062073488', 2, 'Reading'),
(3, '9781250076960', 8, 'On Hold'),
(4, '9780345445605', 8, 'Completed'),
(5, '9780307887436', 8, 'Completed'),
(6, '9780307887436', 2, 'Plan to Read'),
(7, '9781250076960', 2, 'Plan to Read'),
(8, '9781503219700', 2, 'Dropped'),
(9, '9783442178582', 2, 'On Hold'),
(10, '9780553418026', 2, 'Completed'),
(11, '9780345445605', 2, 'Dropped');
...
--
ALTER TABLE `user_buku`
  MODIFY `id_user_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
