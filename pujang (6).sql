...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2024 at 01:56 PM
...
CREATE TABLE `users` (
  ...
  `src_profile` varchar(64) NOT NULL DEFAULT '../image/profile/default.png',
...
INSERT INTO `users` (`id`, `username`, `nama`, `email`, `password`, `src_profile`, `level`) VALUES
(1, 'admin', 'admin', 'admin@gmail.com', '123', '../image/profile/default.png', 'admin'),
(2, 'iqbal', 'Muhammad Iqbal Anandra', 'iqbal@gmail.com', '321', '/Pujang_ADSI/image/profile/iqbal.jpg', 'user'),
(7, 'Jambi', 'Rifqi', 'jambi@gmail.com', 'jambialltheway', '../image/profile/rifki.jpg', 'user'),
(8, 'arip', 'Arip Saputra', 'arip@gmail.com', 'arip', '../image/profile/default.png', 'user'),
(9, 'fer', 'bintang fer', 'bintang@gmail.com', '123', '../image/profile/bintang.png', 'user');
...
INSERT INTO `user_buku` (`id_user_buku`, `ISBN`, `id`, `status`, `is_favorite`) VALUES
(1, '9780156012195', 2, 'Reading', 0),
(2, '9780062073488', 2, 'Reading', 0),
(3, '9781250076960', 8, 'On Hold', 0),
(4, '9780345445605', 8, 'Completed', 0),
(5, '9780307887436', 8, 'Completed', 0),
(6, '9780307887436', 2, 'Plan to Read', 0),
(7, '9781250076960', 2, 'Plan to Read', 0),
(8, '9781503219700', 2, 'Dropped', 0),
(9, '9783442178582', 2, 'On Hold', 0),
(10, '9780553418026', 2, 'Completed', 1),
(11, '9780345445605', 2, 'Dropped', 0),
(13, '9780553418026', 8, 'On Hold', 1);
...
--
ALTER TABLE `user_buku`
  MODIFY `id_user_buku` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
